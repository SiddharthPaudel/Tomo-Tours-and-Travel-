  ...
  return (
    <>
      ...
      <button 
        ...
        className="lg:hidden fixed top-6 left-6 z-50 p-3 bg-[#0f172a] border border-slate-800 text-white rounded-xl shadow-2xl"
      >
      ...
      {/* SIDEBAR */}
      <aside className={`
        fixed h-full z-40 bg-[#0f172a] text-slate-400 flex flex-col border-r border-slate-800/50 font-montserrat transition-all duration-300
        w-64
      ...
      `}>
        ...
        {/* FOOTER ACTIONS */}
        <div className="p-4 border-t border-slate-800/50 bg-slate-900/20 mt-auto">
          <button 
